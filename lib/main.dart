...
import 'package:udemy_flutter_beginner/section_6_layouts/Section6.dart';
              ...
              child: new Column(
                children: <Widget>[
                  new ElevatedButton(onPressed: () => {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Section6(),))
                  }, child: new Text("Section 6")),
                  new ElevatedButton(onPressed: () => {
